...
#  Description: An artificial intelligence agent to solve diagonal sudoku puzzles.
#		The script is based on Udacity AI Nanodegree's tutorial code, and is
#		the first project of the nanodegree.

#  Date       : 10/11/2017

#  Last Edited: 10/08/2017, Kevin Wu

#  History    : - 10/08/2017, Kevin Wu: initial script
...
####		1) Variables			####
####################################################
# first define cross function to generate variables needed for the Sudoku AI
def cross(a, b):
    "Cross product of elements in a and elements in b."
    return [s+t for s in a for t in b]

# define variables needed for the Sudoku AI
assignments = []
rows = 'ABCDEFGHI'
cols = '123456789'
